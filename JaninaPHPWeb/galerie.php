        ...
        <div id="content" class="main_content container">
            ...
            <div class="image-row">
                <div class="image-set">
                    ...
                    <a class="example-image-link" href="/images/gallery/santa1-velky.jpg" data-lightbox="makeup-set" title="Foto make-up - vánoční focení">
                        <img class="example-image" src="/images/gallery/santa1-nahled.jpg" alt="Foto make-up - vánoční focení" width="150" height="150"/>
                    </a>
                    <a class="example-image-link" href="/images/gallery/santa2-velky.jpg" data-lightbox="makeup-set" title="Foto make-up - vánoční focení">
                        <img class="example-image" src="/images/gallery/santa2-nahled.jpg" alt="Foto make-up - vánoční focení" width="150" height="150"/>
                    </a>
                </div>
            </div>
            ...
            <div class="image-row">
                <div class="image-set">
                    <a class="example-image-link" href="/images/gallery/nevestaTereza-velky.jpeg" data-lightbox="svatba-set" title="Svatební líčení - Nevěsta Terka">
                        <img class="example-image" src="/images/gallery/nevestaTereza-nahled.jpeg" alt="Svatební líčení - Nevěsta Terka" width="150" height="150"/>
                    </a>
                    <a class="example-image-link" href="/images/gallery/nevestaZuzka-velky.jpg" data-lightbox="svatba-set" title="Svatební líčení - Nevěsta Zuzka">
                        <img class="example-image" src="/images/gallery/nevestaZuzka-nahled.jpg" alt="Svatební líčení - Nevěsta Zuzka" width="150" height="150"/>
                    </a>
                    <a class="example-image-link" href="/images/gallery/nevestaPavla-velky.jpg" data-lightbox="svatba-set" title="Svatební líčení - Nevěsta Pavla">
                        <img class="example-image" src="/images/gallery/nevestaPavla-nahled.jpg" alt="Svatební líčení - Nevěsta Pavla" width="150" height="150"/>
                    </a>
                    <a class="example-image-link" href="/images/gallery/nevestaJana-velky.jpg" data-lightbox="svatba-set" title="Svatební líčení - Nevěsta Jana">
                        <img class="example-image" src="/images/gallery/nevestaJana-nahled.jpg" alt="Svatební líčení - Nevěsta Jana" width="150" height="150"/>
                    </a>
                </div>
            </div>
